...
router.get('/bio', function (req, res) {
  ...
  res.render('bio', {
    ...
    quotes: [
      ...
      {
        text: 'The most beautiful thing we can experience is the mysterious. It is the source of all true art and all science.',
      },
    ],
    major_discoveries: [
      {
  ...
  res.render('task31', {
    ...
    city: {
      ...
      cards: [
        {
          picture: {
            src: 'https://img.kapital.kz/RFuq_AV0iDU/bG9jYWw6Ly8vbGVnYWN5L2ltYWdlcy9hL2EvOC81LzkvZjExZTU5Y2I0ZWU4ZDZhMzlhOGFkMmE4N2EzLnBuZw',
            alt: 'New York',
          },
          title: 'New York City',
          description:
        ...
        {
          picture: {
            src: 'https://tripmydream.cc/travelhub/travel/block_gallery/10/9665/gallery_first_109665.jpg?1397',
            alt: 'Paris',
          },
          title: 'Paris',
          description:
        ...
        {
          picture: {
            src: 'https://feerie.com.ua/sites/default/files/styles/for_blog/public/2019-03/tokyo-hp-gq-19oct18_istock_b.jpg?itok=X-ZCq6nh',
            alt: 'Tokyo',
          },
          title: 'Tokyo',
          description:
        ...
        {
          picture: {
            src: 'https://flytothesky.ru/wp-content/uploads/2019/01/9087-1.jpg',
            alt: 'Sydney',
          },
          title: 'Sydney',
          description:
